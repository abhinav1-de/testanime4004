  ...
  return (
    <SearchProvider>
      ...
      >
        ...
        {/* Join Room Modal */}
        {showJoinPanel && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[1000001] fade-in p-4">
            <div className="glass-morphism bg-gradient-to-br from-gray-900/95 to-gray-800/95 border border-white/20 rounded-xl p-4 sm:p-6 w-full max-w-sm sm:max-w-md shadow-2xl fade-in-scale">
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                <h3 className="text-white text-base sm:text-lg font-semibold" style={{ fontVariant: 'small-caps' }}>ᴊᴏɪɴ ʀᴏᴏᴍ</h3>
                <button
              ...
              <div className="space-y-4 sm:space-y-5">
                <div className="fade-in delay-100">
                  <label className="block text-gray-300 text-xs sm:text-sm mb-2" style={{ fontVariant: 'small-caps' }}>ʏᴏᴜʀ ᴜꜱᴇʀɴᴀᴍᴇ</label>
                  <input
                    type="text"
                    value={username}
                    onChange={(e) => setUsername(e.target.value)}
                    className="w-full px-3 py-2.5 sm:py-2 glass bg-gray-800/50 text-white rounded-lg border border-gray-600/50 focus:border-blue-500/80 focus:outline-none transition-all duration-200 backdrop-blur-sm text-sm"
                ...
                <div className="fade-in delay-200">
                  <label className="block text-gray-300 text-xs sm:text-sm mb-2" style={{ fontVariant: 'small-caps' }}>ʀᴏᴏᴍ ᴄᴏᴅᴇ</label>
                  <input
                    type="text"
                    value={roomCode}
                ...
                <button
                  ...
                  className="w-full glass-morphism bg-gradient-to-r from-blue-600/90 to-purple-600/90 hover:from-blue-500/90 hover:to-purple-500/90 disabled:from-gray-600/50 disabled:to-gray-600/50 disabled:cursor-not-allowed text-white py-2.5 sm:py-2 px-4 rounded-lg font-medium transition-all duration-300 hover:scale-105 backdrop-blur-md border border-white/10 fade-in delay-300 flex items-center justify-center gap-2 text-sm"
                  style={{ fontVariant: 'small-caps' }}
                >
                  <span>ᴊᴏɪɴ ʀᴏᴏᴍ</span>
                ...
                {roomError && (
                  <div className="text-red-400 text-xs sm:text-sm text-center fade-in" style={{ fontVariant: 'small-caps' }}>
                    {roomError}
                  </div>
                )}
              </div>
